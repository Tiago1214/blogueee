        ...
        <div class="col-md-8">
            <div class="card">
                <div class="card-header">
                      <?php echo e(__('Criar Noticia')); ?></div>
                <div class="card-body">
                ...
                <?php endif; ?>
                <form action="<?php echo e(route('noticias.store')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
                        ...
                        <div class="form-group">
                            ...
                            <?php $__currentLoopData = $categorias; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $categoria): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                <option value="<?php echo e($categoria->id); ?> " 
                                    <?php if($categoria->id == old('categoria')): ?>
                                        selected
                                    <?php endif; ?>
                                    > <?php echo e($categoria->categorianome); ?> </option>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\blogue\resources\views/noticias/create.blade.php ENDPATH**/ ?>